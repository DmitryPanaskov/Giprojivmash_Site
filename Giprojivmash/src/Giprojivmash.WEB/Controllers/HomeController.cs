...
namespace Giprojivmash.WEB.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public IActionResult Index()
        {
            ...
            model.PageDescription = "Официальный сайт проектного института (проектной организации) в Гомеле, Республике Беларусь (РБ)" +
                " ОАО Гипроживмаш занимаемя проектированием, сметной документацией, обоснованием инвестиций, геодезий, экологией, безопасностью, промышленной безопасностью";
            return View(model);
        }
